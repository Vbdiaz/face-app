  ...
  return (
    <div className="relative max-w-4xl mx-auto p-6">
        <div className="bg-white shadow-lg rounded-lg p-6">
            ...
            <p> OpenCV. (n.d.). <em>Cascade classifier.</em> <a href="https://docs.opencv.org/3.4/db/d28/tutorial_cascade_classifier.html" class="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">https://docs.opencv.org/3.4/db/d28/tutorial_cascade_classifier.html</a></p>
            </div>
            ...
            <p>GeeksforGeeks. (2024, March 14). <em>Introduction to convolution neural network. </em><a href="https://www.geeksforgeeks.org/introduction-convolution-neural-network/" class="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">https://www.geeksforgeeks.org/introduction-convolution-neural-network/</a></p>
            </div>
            ...
            <p>DigitalScreeni. (n.d.) <em>Home</em> [Youtube channel]. Youtube. Retrieved August 28, 2024, from <a href="https://www.youtube.com/@DigitalSreeni" class="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">https://www.youtube.com/@DigitalSreeni</a></p>
            </div>
        </div>
    </div>
  );
